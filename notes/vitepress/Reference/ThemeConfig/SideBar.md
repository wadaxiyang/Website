...
```
If you have a directory structure similar to the one presented below (consistent with this article), then the Sidebar can automatically identify subdirectories as secondary bars without needing manual setup, and it will share a common `index.md` file among them.
